...
store_t::sindex_access_t::sindex_access_t(btree_slice_t *_btree, secondary_index_t _sindex,
                                          scoped_ptr_t<real_superblock_t> _super_block)
    : btree(_btree), sindex(_sindex), super_block(std::move(_super_block))
{ }
